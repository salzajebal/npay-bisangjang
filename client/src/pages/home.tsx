...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white" data-testid="home-page">
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-white/95 backdrop-blur-sm shadow-sm" : "bg-transparent"}`}>
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 h-16">
          <div className="flex items-center gap-2">
            ...
            <span className={`font-bold text-lg transition-colors ${scrolled ? "text-gray-900" : "text-white"}`}>IBK기업증권</span>
          </div>
          ...
          <div className="hidden md:flex items-center gap-2">
            {user ? (
              ...
              <>
                ...
                <Link href="/register">
                  <Button size="sm" className="gap-1.5 bg-[#004B9C] border-[#004B9C]" data-testid="button-register">
              ...
              <div className="border-t pt-2 mt-2 space-y-2">
                {user ? (
                  ...
                  <>
                    ...
                    <Link href="/register">
                      <button onClick={() => setMobileMenuOpen(false)} className="w-full text-left px-4 py-2.5 text-sm font-medium text-[#004B9C] rounded-md flex items-center gap-2" data-testid="mobile-register">
                        <UserPlus className="w-4 h-4" /> 회원가입
                      </button>
                    </Link>
                  </>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden" style={{ background: "linear-gradient(135deg, #004B9C 0%, #002D5E 40%, #001A3A 100%)" }} data-testid="hero-section">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-20 left-10 w-72 h-72 bg-[#0066CC]/20 rounded-full blur-3xl" />
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-[#003366]/30 rounded-full blur-3xl" />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#004B9C]/10 rounded-full blur-3xl" />
        </div>
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto">
          ...
          <h1 className="text-white text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-tight tracking-tight mb-4">
            <span className="block text-white/70 text-lg sm:text-2xl md:text-3xl font-medium tracking-widest mb-3">IBK기업증권에서</span>
          ...
          <div className="flex items-center justify-center gap-3 sm:gap-4 my-6 sm:my-8">
            <div className="w-16 sm:w-20 h-8 sm:h-10 bg-white/20 rounded-full flex items-center px-1">
              <div className="w-6 sm:w-8 h-6 sm:h-8 bg-white rounded-full flex items-center justify-center shadow-lg ml-auto">
                <TrendingUp className="w-3 sm:w-4 h-3 sm:h-4 text-[#004B9C]" />
              </div>
            </div>
          ...
          <p className="text-white/70 text-base sm:text-lg md:text-xl mb-8 sm:mb-10 max-w-xl mx-auto leading-relaxed">
            투자의 시작, 믿을 수 있는 IBK기업증권에서<br className="hidden sm:block" />
            안전하고 편리한 주식 관리 서비스
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            <Link href="/register">
              <Button size="lg" className="w-full sm:w-auto min-w-[200px] bg-white text-[#004B9C] hover:bg-gray-100 font-bold text-base h-12 sm:h-14 rounded-full gap-2 no-default-hover-elevate" data-testid="button-hero-register">
      ...
      <section id="features" className="py-16 sm:py-24 bg-white" data-testid="features-section">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 sm:mb-16">
            <Badge className="bg-[#004B9C]/10 text-[#004B9C] border-[#004B9C]/20 mb-4 no-default-hover-elevate no-default-active-elevate">서비스 소개</Badge>
            <h2 className="text-2xl sm:text-4xl font-black text-gray-900 mb-4">
              IBK기업증권이 제공하는<br />주식 관리 서비스
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              { icon: BarChart3, title: "실시간 시세 조회", desc: "삼성전자(005930) 실시간 시세와 차트를 한눈에 확인하세요", color: "bg-blue-50 text-blue-600" },
              { icon: Shield, title: "안전한 자산 관리", desc: "IBK기업증권의 검증된 시스템으로 소중한 자산을 보호합니다", color: "bg-green-50 text-green-600" },
      ...
      <section className="py-16 sm:py-24 bg-white" data-testid="event-section">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-14">
            <Badge className="bg-[#004B9C]/10 text-[#004B9C] border-[#004B9C]/20 mb-4 no-default-hover-elevate no-default-active-elevate">이벤트</Badge>
            <h2 className="text-2xl sm:text-4xl font-black text-gray-900 mb-4">
              IBK기업증권에서는<br />주식모으기 수수료 부담없이!
            </h2>
          </div>
            ...
            <Card className="p-6 sm:p-8 bg-gray-50 border-gray-100" data-testid="card-event-detail">
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <p className="text-gray-700">주식 모으기 서비스를 이용하는<br />IBK기업증권 고객 누구나!</p>
                </div>
              </div>
            </Card>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-8 pt-6 border-t border-white/10">
            ...
            <div className="text-white/40 text-xs space-y-1.5 leading-relaxed">
              <p>- IBK기업증권이라면 누구나 이벤트에 참여 가능합니다.</p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-white/60 text-sm font-medium">IBK기업증권</span>
            </div>
          ...
          <div className="mt-6 text-center sm:text-left">
            <p className="text-white/30 text-xs">
              IBK기업증권 주식관리 시스템 | 본 서비스는 투자 참고용이며, 투자 판단의 책임은 투자자에게 있습니다.
            </p>
          </div>
        </div>
      </footer>
